...
## Algorithm
```
1.Load dataset and select input features (X) and target variables (Y), then split into training and testing sets.
2.Standardize (scale) both input features and target outputs using training data statistics.
3.Initialize the SGDRegressor wrapped inside MultiOutputRegressor for multi-output prediction.
4.Train the model on scaled training data and generate predictions on scaled test data.
5.Inverse-transform predictions to original scale and evaluate performance using Mean Squared Error
```
## Program:
```
/*
...
<img width="883" height="363" alt="image" src="https://github.com/user-attachments/assets/d8930092-cd8c-42dc-a506-d3c86649f3ab" />
<img width="660" height="587" alt="image" src="https://github.com/user-attachments/assets/7d3fe746-1c64-4226-beda-9cf670c3956f" />
